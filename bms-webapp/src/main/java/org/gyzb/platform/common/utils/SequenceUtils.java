...
import org.gyzb.platform.common.utils.InetUtils;
...
public class SequenceUtils {
	...
	public static String getJobLogId() {
		...
		return InetUtils.getLastSplitIp3() + DateUtils.getTimestampStrNo().substring(2)+ fillLeftWith0(currSeq, 4);
	}
	 ...
	 * @return
	 */
	private synchronized static long getCycNum1() {
		CYC_NUM1 %= 1000000000;
	 ...
	 * @return
	 */
	private synchronized static long getCycNum3() {
		CYC_NUM3 %= 1000000000;

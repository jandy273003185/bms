...
public class WebUtils {
   ...
   */
  public static void showReturnLinkWithLinkId(
      String returnLinkTitle, String linkId, Map<String, String[]> params) {
    Map<String, RequestLink> requestMap =
        (Map<String, RequestLink>) getHttpSession().getAttribute(Constants.Platform.REQUEST_MAP);
   ...
   * @param params 返回链接参数
   */
  public static void showReturnLink(
      String returnLinkTitle, String linkUri, Map<String, String[]> params) {
  ...
  public static void disableShowReturnLastPage() {
    requests
        .get()
        .setAttribute(Constants.Platform.DISABLE_LASTPAGE, Constants.Platform.DISABLE_LASTPAGE);
  }

...
public class PrivilegeFilter implements Filter {
  ...
  /** 需要登录的公共功用 */
  private String[] commonPage = {"/common/files/moveFile","/common/files/upload","/common/files/uploadPic","/common/files/getPicPath"};
      ...
      if (!PrivilegeUtils.hasFunc(user, func)) {
        ...
        if (request.getParameter(Constants.Platform.AJAX) != null) {
          ...
          httpServletRequest.setAttribute(
              Constants.Platform.EXCEPTION_KEY, new Exception("非法请求: 您当前无此权限进行该操作:" + requestURI));
          RequestDispatcher dispatcher =

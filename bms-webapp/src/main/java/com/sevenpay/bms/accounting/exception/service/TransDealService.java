package com.sevenpay.bms.accounting.exception.service;
...
import com.sevenpay.bms.accounting.exception.base.bean.TransAction;
import com.sevenpay.bms.accounting.exception.base.type.DealType;
import com.sevenpay.bms.accounting.exception.dao.acctseven.bean.AcctSevenFreeze;
import com.sevenpay.bms.accounting.exception.dao.acctseven.bean.AcctSevenTrans;
import com.sevenpay.bms.accounting.exception.dao.acctseven.mapper.AcctSevenFreezeMapper;
import com.sevenpay.bms.accounting.exception.dao.acctseven.mapper.AcctSevenTransMapper;
import com.sevenpay.bms.accounting.exception.dao.clearbank.bean.ClearBank;
import com.sevenpay.bms.accounting.exception.dao.clearbank.mapper.ClearBankMapper;
import com.sevenpay.bms.accounting.exception.dao.clearjgkj.bean.ClearJgkj;
import com.sevenpay.bms.accounting.exception.dao.clearjgkj.bean.ClearJgkjTransfer;
import com.sevenpay.bms.accounting.exception.dao.clearjgkj.mapper.ClearJgkjMapper;
import com.sevenpay.bms.accounting.exception.dao.kingdeeclear.bean.KingdeeClear;
...
import com.sevenpay.bms.accounting.exception.dao.operfreeze.bean.OperFreeze;
import com.sevenpay.bms.accounting.exception.dao.operfreeze.mapper.OperFreezeMapper;
import com.sevenpay.bms.accounting.exception.dao.operrefund.mapper.OperRefundMapper;
import com.sevenpay.bms.accounting.exception.dao.operrevoke.bean.OperRevoke;
import com.sevenpay.bms.accounting.exception.dao.operrevoke.mapper.OperRevokeMapper;
import com.sevenpay.bms.accounting.exception.dao.opertrade.mapper.OperTradeMapper;
import com.sevenpay.bms.accounting.exception.dao.transrecord.bean.TransRecord;
import com.sevenpay.bms.accounting.exception.dao.transrecord.mapper.TransRecordMapper;
...
import com.sevenpay.bms.accounting.exception.dao.transyl.bean.TransYl;
import com.sevenpay.bms.accounting.exception.dao.transyl.dao.TransYlDao;
...
public class TransDealService {
	...
	public JSONObject restart(TransAction requestBean) {
		...
		if (null == response || null == response.getRtnResult()) {
			...
			case CUST_RECHARGE:
				com.sevenpay.bms.basemanager.recharge.bean.RechargeBean rechargeBean = new com.sevenpay.bms.basemanager.recharge.bean.RechargeBean();

...
<%-- 		$.ajax({
	...
	$(".qifenqian_code_tc").click(function(){
		...
		var path = "https://combinedpay.qifenqian.com/pub/merchantqr.do?mid=" +merchantCode +"&sn=" + shopNo;
		$("#qrcode").qrcode({
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt20">
                                 ...
                                 <div class="col-xs-3 pd0 text-center"><label>
                                 	<input name="newRecode" type="radio" onclick="hiddenBackPic();" data-toggle="modal" data-target="#myModal2" value="oldRecodeClass"> 
                                 	原始样式
                                 </label></div>
                            </div>

					    ...
					    <div class="aui-content-up">
					    	<form  id="merchantForm" action='<c:url value="<%=MerchantEnterReportedPath.BASE + MerchantEnterReportedPath.YQBMERCHANTREPORT %>"/>' method="post">
		                        ...
		                        <tr>
									...
									<td class="td-right"> 
										<input type="text" id="account" name="account" maxlength="100" placeholder="请输入支付宝账号"  style="width:90%">
										<label id="accountLab" class="label-tips"></label>
									</td>
								</tr>
								<tr id="next_id">
									<td colspan="4" class="headlerPreview" style="background:#7ebde1;">联系人信息</td>
								</tr>
		                        <tr>
									<td class="td-left">联系人名称：<span style="color:red;">(必填)</span></td>
									<td class="td-right"> 
										<input type="text" id="contactName" name="contactName" maxlength="100" placeholder="请输入联系人名字"  value="${custInfo.contactName }" style="width:90%">
										<label id="contactNameLab" class="label-tips"></label>
									</td>
	                                <td class="td-left">联系人手机号码：<span style="color:red;">(必填)</span></td>
									<td class="td-right"> 
										<input type="text" id="contactMobile" name="contactMobile" maxlength="100" placeholder="请输入联系人手机号码"  value="${custInfo.contactMobile }" style="width:90%">
								...
								<tr>
									...
									<td class="td-right"> 
										<input type="text" id="contactEmail" name="contactEmail" maxlength="100" placeholder="请输入联系人邮箱"  value="${custInfo.merchantEmail }" style="width:90%">
								...
								<tr id="industryType" style = "display:" >
									...
									<td class="td-right" colspan="4"> 
		                                <select name="levelOne" id="levelOne" class="width-80" onchange="getLevel('levelTwo',this.value)" >
		                                ...
		                                <select name="levelTwo" id="levelTwo" class="width-80" onchange="getLevel('levelThree',this.value)" >
							...
							<tr id="businessAuthPhotoType" style = "display:">
								...
								<td class="td-right" colspan="3">
									<a data-toggle='modal' class="tooltip-success "  data-target="#previewImageModal"  >
										<label id="businessAuthPhotoDiv"style="float:left;background-color:rgb(222, 222, 222); width:120px;height:100px; margin: 10 10 10 10">  
										        <img  id="businessAuthPhotoImageDiv" onclick="bigImg(this);" style="width:100%;height:100%;display:none" />
										</label>
									</a>
									<div class="updateImageDiv" style="float:left; margin-top:75" >
										<input  type="hidden" id="businessAuthPhotoPath" name="businessAuthPhotoPath" />
										<input type="file" name="businessAuthPhoto" id="businessAuthPhoto" onchange="showBusinessAuthPhoto(this)"/>
										<span style="color:gray">支持*jpg、*jpeg、*gif、*bmp、*png图片格式</span>
									</div>
								</td>
							</tr>

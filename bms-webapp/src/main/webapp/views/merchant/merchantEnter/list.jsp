...
<link rel="stylesheet" href="<c:url value='/static/css/dropzone.css' />" />
...
<link rel="stylesheet" href="<c:url value='/static/css/gyzb-admin.css' />" />
<link rel="stylesheet" href="<c:url value='/static/js/WdatePicker.css' />" />
<link rel="stylesheet" href="<c:url value='/static/js/AutoDatePicker.css' />" />
...
<script src='<c:url value="/static/js/typeahead-bs2.min.js"/>'></script>
<script src='<c:url value="/static/js/dropzone.min.js"/>'></script>
<script src='<c:url value="/static/js/ace-elements.min.js"/>'></script>
<script src='<c:url value="/static/js/ace.min.js"/>'></script>
<script src='<c:url value="/static/js/gyzb-admin.js"/>'></script>
...
<script src='<c:url value="/static/js/WdatePicker.js"/>'></script>
<script src='<c:url value="/static/js/AutoDatePicker.js"/>'></script>
<script src='<c:url value="/static/js/jquery-ui.min.js"/>'></script>
<script src='<c:url value="/static/js/jquery.divbox.js"/>'></script>
<script src='<c:url value="/static/js/ajaxfileupload.js"/>'></script>
<script src='<c:url value="/static/js/mobileBUGFix.mini.js"/>'></script>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
								...
								<c:forEach items="${merchantList }" var="merchant">
									<tr class="merchant" id="merchant">
										...
										<td>
											...
											<%-- <gyzbadmin:function url="<%=MerchantEnterPath.BASE + MerchantEnterPath.PRODUCT %>">
												<a href="#" class="" onclick="channelMerchantEntry(this)"  data-target="#channelListModel"  data-rel="tooltip" title="Query" data-toggle='modal'>
				...
				<!-- 确认弹框 -->
				<div class="modal fade" style="z-index:1043;" id="confirmModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				   <div class="modal-dialog" style="width:30%;z-index:99;">
				      <div class="modal-content" >
				      <div class="modal-header" style="background-color:0099CC">
				            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				         ...
				         <div class="modal-footer">
				            <button type="button" class="btn btn-default messageDefault" data-dismiss="modal">取消</button>
				            <button type="button" class="btn btn-primary addadBtn" onclick="choiceChannel-1()">查看</button>
				         </div>
				      </div><!-- /.modal-content -->
				   </div>
				</div><!-- /.modal -->

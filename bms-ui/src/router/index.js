...
const Role = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Role/Role');
const Menu = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Menu/Menu');
const Depart = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Depart/Depart');
const TaskConfig = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/TaskConfig/TaskConfig');
const TaskLog = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/TaskLog/TaskLog');
const SmsLog = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/SmsLog/SmsLog');
const Test = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Test/Test');
const Auth = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Market/Auth/Auth');
const Group = () =>
    import ( /* webpackChunkName: "system" */ '@/views/System/Market/Group/Group');
// 异常列表
const Account = () =>
    import ( /* webpackChunkName: "abnormal" */ '@/views/Abnormal/Account/Account');
const Exchange = () =>
    import ( /* webpackChunkName: "abnormal" */ '@/views/Abnormal/Exchange/Exchange');
const Message = () =>
    import ( /* webpackChunkName: "abnormal" */ '@/views/Abnormal/Message/Message');
// 工作流管理
const Wuser = () =>
    import ( /* webpackChunkName: "Workflow" */ '@/views/Workflow/Wuser/Wuser');
const Wgroup = () =>
    import ( /* webpackChunkName: "Workflow" */ '@/views/Workflow/Wgroup/Wgroup');
// 交易管理
const Consumption = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Consumption/Consumption');
const Summary = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Summary/Summary');
const Recharge = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Recharge/Recharge');
const Revocation = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Revocation/Revocation');
const Refund = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Refund/Refund');
const Transfer = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Transfer/Transfer');
const Transactions = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Transactions/Transactions');
const RechargeRe = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/RechargeRe/RechargeRe');
const TransferRe = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/TransferRe/TransferRe');
const Merchants = () =>
    import ( /* webpackChunkName: "Trading" */ '@/views/Trading/Merchants/Merchants');
// 聚合支付
const Adaily = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Agent/Adaily/Adaily');
const Agreement = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Agent/Agreement/Agreement');
const Settlement = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Agent/Settlement/Settlement');
const Limit = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Merchants/Limit/Limit');
const Mdaily = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Merchants/Mdaily/Mdaily');
const Rate = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Merchants/Rate/Rate');
const Mrefund = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Merchants/Mrefund/Mrefund');
const Mexchange = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Merchants/Mexchange/Mexchange');
const Olist = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Order/List/List');
const Orefund = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Order/Orefund/Orefund');
const Pchannels = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Product/Channels/Channels');
const Pmanage = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Product/Manage/Manage');
const Exception = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Exception/Exception');
const Arouter = () =>
    import ( /* webpackChunkName: "Aggregate" */ '@/views/Aggregate/Router/Router');
// 物料管理
const Mmanage = () =>
    import ( /* webpackChunkName: "Material" */ '@/views/Material/Manage/Manage');
// 财务管理
const Fsettlement = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Settlement/Settlement');
const Fquery = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Query/Index');
const Reconcilia = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Reconcilia/Index');
const SourceData = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/SourceData/Index');
const Unionpay = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Unionpay/Index');
const Fabnormal = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Abnormal/Abnormal');
const Kingdee = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Kingdee/Index');
const Citic = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/Citic/Index');
const ReSummary = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/ReSummary/ReSummary');
const ErrorHand = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/ErrorHand/ErrorHand');
const ReSummaryV2 = () =>
    import ( /* webpackChunkName: "Financial" */ '@/views/Financial/ReSummaryV2/ReSummary');
// 码表维护
const Holiday = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Holiday/Holiday');
const Poundage = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Poundage/Poundage');
const Bank = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Bank/Bank');
const Certificate = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Certificate/Certificate');
const City = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/City/City');
const Problem = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Problem/Problem');
const Advertising = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Advertising/Advertising');
const Template = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Template/Template');
const Dictionary = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Dictionary/Dictionary');
const Ctrading = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Trading/Trading');
const Withdrawal = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Withdrawal/Withdrawal');
const Branch = () =>
    import ( /* webpackChunkName: "Clock" */ '@/views/Clock/Branch/Branch');
// 商户管理
const Gateway = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Gateway/Gateway');
const Protocol = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Protocol/Protocol');
const Mrate = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Rate/Rate');
const Maccount = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Account/Account');
const Mcashier = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Cashier/Cashier');
const Shop = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Shop/Shop');
const Mchannel = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Channel/Channel');
const Mlist = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/List/List');
const Operation = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/List/Operation');
const Reported = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Reported/Reported');
const Mproduct = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Product/Product');
const Equipment = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Equipment/Equipment');
const Service = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Service/Service');
const Soperation = () =>
    import ( /* webpackChunkName: "Merchants" */ '@/views/Merchants/Service/Operation');
// 客户管理
const Audit = () =>
    import ( /* webpackChunkName: "Customer" */ '@/views/Customer/Audit/Audit');
const Aulist = () =>
    import ( /* webpackChunkName: "Customer" */ '@/views/Customer/List/List');
const Caccount = () =>
    import ( /* webpackChunkName: "Customer" */ '@/views/Customer/Account/Account');
// 短信管理
const Smessage = () =>
    import ( /* webpackChunkName: "SMS" */ '@/views/SMS/Message/Message');
// 实名认证
const Clist = () =>
    import ( /* webpackChunkName: "Certification" */ '@/views/Certification/List/List');
const Cverify = () =>
    import ( /* webpackChunkName: "Certification" */ '@/views/Certification/Verify/Verify');
// 代理商管理
const Agents = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/Agents/Agents');
const Regist = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/Regist/Regist');
const MRegist = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/MRegist/MRegist');
const AgentsList = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/AgentsList/AgentsList');
const AgentsCheckList = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/AgentsCheckList/AgentsCheckList');
const AgentsReport = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/AgentsReport/AgentsReport');
const AgentsProtocol = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/AgentsProtocol/AgentsProtocol');
const AgentsMerchantsCheck = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/AgentsMerchantsCheck/AgentsMerchantsCheck');
const ServiceGisterCheck = () =>
    import ( /* webpackChunkName: "Agent" */ '@/views/Agent/ServiceGisterCheck/ServiceGisterCheck');

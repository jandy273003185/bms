  ...
  <div class='merchanrts-list-operation-page'>
    ...
    <el-form :model="merchanrtsInfo" label-width="130px" :disabled="isLook" :inline="true" ref="controlQueryForm" :show-message="false">
      <table class="info-item-table" border="1">
        <tr>
          <td colspan="3">
            <el-form-item label="商户账号" prop="name1" required>
    ...
    <el-form :model="basicInfo" label-width="130px" :disabled="isLook" :inline="true" ref="controlQueryForm" :show-message="false">
      <table class="info-item-table" border="1">
        <tr>
          <td>
            <el-form-item label="商户类型" prop="name2" required>
          ...
          <td>
            <el-form-item label="商户名称" prop="name3" required>
              <el-input v-model="basicInfo.name3" placeholder="请输入商户名称"></el-input>
            </el-form-item>
          </td>
          <td>
            <el-form-item label="商户简称" prop="name4" required>
              <el-input v-model="basicInfo.name4" placeholder="请输入商户简称"></el-input>
            </el-form-item>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <el-form-item label="商户邮箱" prop="name5" required>
              <el-input v-model="basicInfo.name5" placeholder="请输入商户邮箱"></el-input>
            </el-form-item>
          </td>
          <td>
        ...
        <tr>
          <td colspan="2">
            <el-form-item label="商户地址" prop="address" required class="form-item-address">
        ...
        <tr>
          ...
          <td>
            <el-form-item label="所属业务人员" prop="name9" required>
              <el-input v-model="basicInfo.name9"></el-input>
            </el-form-item>
          </td>
          <td>
            <el-form-item label="所属代理商" prop="name10" required>
              <el-input v-model="basicInfo.name10"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3">
            <el-form-item prop="name12" label="门头照照片" required>
              <SiteUpload v-model="basicInfo.name12" />
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3">
            <el-form-item prop="name13" label="店内照" required>
              <SiteUpload v-model="basicInfo.name13" />
            </el-form-item>
          </td>
        </tr>
        <tr>
          <td colspan="3">
            <el-form-item prop="name14" label="店内前台照" required>
              <SiteUpload v-model="basicInfo.name14" />
            </el-form-item>
          </td>
        </tr>
      </table>
    ...
    <el-form :model="basicInfo" label-width="130px" :disabled="isLook" :inline="true" ref="controlQueryForm" :show-message="false">
      <table class="info-item-table" border="1">
        <tr>
          ...
          <td>
            <el-form-item label="身份证有效期" prop="name17" required>
              <el-date-picker v-model="basicInfo.name17" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd">
              </el-date-picker>
            </el-form-item>
            &nbsp;
            <el-button type="success">长期</el-button>
          </td>
        </tr>
        <tr>
          <td colspan="3">
